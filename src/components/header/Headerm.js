...
const Headerm=(props)=>{
    ...
    return(
        <div className="headerm">
           ...
           <Link to={activatelinks[3]}><Dvd activate={activate} id={3} class="dvdm" name="Popular Tv Shows" no="04" z={3} imgurl="https://images.hdqwalls.com/wallpapers/mortal-kombat-x-game-of-thrones-o4.jpg"/></Link>
           <Link to={activatelinks[4]}><Dvd activate={activate} id={4} class="dvdm" name="Top Rated Movies" no="05" z={2} imgurl="https://images4.alphacoders.com/118/1185748.jpg"/></Link>
